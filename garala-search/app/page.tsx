    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex w-full md:w-2/3 shadow-sm">
              <input 
                ...
                className="flex-1 p-3 border rounded-l-xl focus:outline-none focus:ring-2 focus:ring-orange-500"
                value={search}
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        <div className="mb-6 flex justify-between items-center">
          <h2 className="text-xl font-semibold">Annonces récentes ({ads.length})</h2>
        </div>
              ...
              <div key={ad.id} className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-300 border border-gray-100 flex flex-col">
                ...
                <div className="p-5 flex-1 flex flex-col">
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="text-lg font-bold text-gray-800 leading-tight">{ad.title}</h3>
                  </div>
                  ...
                  <div className="pt-4 border-t mt-auto">
                    ...
                    <a 
                      href={`https://wa.me/${ad.seller_phone}`} 
                      target="_blank"
        ...
        {!loading && ads.length === 0 && (
          <div className="text-center py-20">
            <p className="text-gray-500 text-xl">Aucune annonce trouvée pour cette recherche.</p>
          </div>
        )}
      </main>
    </div>
